    ...
    return {
        ...
        execute: function() {
            ...
            OrderService = (function () {
                ...
                // Add new Hero
                OrderService.prototype.post = function (hero) {
                ...
                OrderService.prototype.put = function (hero) {
                ...
                OrderService.prototype.delete = function (hero) {
                    var headers = new http_1.Headers();
                    headers.append('Content-Type', 'application/json');
                    var url = this.ApiUrlOrder + "/" + hero.id;
                ...
                OrderService.prototype.save = function (hero) {
                    if (hero.id) {
