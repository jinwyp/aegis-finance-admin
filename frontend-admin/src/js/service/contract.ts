...
class Contract {
    ...
    cashDepositCapital : string;                            //中文保证金
    sellerReceiptPrice : any;                                //卖家开票价格  
    sellerReceiptAmount : any;                               //卖家开票吨数  
    sellerReceiptMoney : any;                                //卖家开票金额  
    sellerReceiptMoneyCapital : string;                            //中文保证金
    buyerSettlementMoney : number;                              //买家已经结清金额
    buyerSettlementMoneyCapital : string;                            //中文保证金//   
    ...
    coalSupplier : string;                                 //供应商    
    upstreamContractNo : string;                                 //上游合同编号    
    quantityAcceptanceBasis : any;                              //数量验收依据    
