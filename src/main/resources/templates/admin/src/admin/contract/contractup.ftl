    ...
    <div style="width: 1100px;margin: 0 auto 50px;">
        ...
        <div style="line-height: 32px;text-align: right;">合同编号：<span style="border-bottom: 1px solid black;padding: 0 10px;display: inline-block;min-width: 160px;">${contractNo!'--'}</span></div>
