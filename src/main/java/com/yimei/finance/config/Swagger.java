...
public class Swagger {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.yimei.finance"))
                ...
                .tags(
                        ...
                        new Tag("admin-api-company", "管理后台 RESTful API 业务线"),
                        ...
                        new Tag("warehouse-admin-api-user", "仓押后台 RESTful API 用户相关接口"),
                        new Tag("warehouse-admin-api-company", "仓押后台 RESTful API 公司相关接口")
                );
    }
