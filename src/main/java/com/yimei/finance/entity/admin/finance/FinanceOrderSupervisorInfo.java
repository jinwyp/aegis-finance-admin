...
public class FinanceOrderSupervisorInfo extends BaseEntity implements Serializable {
    ...
    @Column(name = "operating_storage_detail", length = 5020, columnDefinition = "TEXT")
    private String operatingStorageDetail;                           //经营及堆存情况

    @Column(name = "port_standard_degree", length = 5020, columnDefinition = "TEXT")
    private String portStandardDegree;                               //保管及进出口流程规范程度

    @Column(name = "supervision_cooperate_detail", length = 5020, columnDefinition = "TEXT")
    private String supervisionCooperateDetail;                       //监管配合情况

    @Column(name = "supervision_scheme", length = 5020, columnDefinition = "TEXT")
