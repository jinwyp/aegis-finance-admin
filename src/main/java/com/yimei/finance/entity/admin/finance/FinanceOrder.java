...
public class FinanceOrder extends BaseEntity implements Serializable {
    ...
    @Column(name = "financing_amount", precision = 18, scale = 2)
    ...
    @Column(name = "business_amount", precision = 8, scale = 2)
    ...
    @Column(name = "procurement_price", precision = 8, scale = 2)
    ...
    @Column(name = "selling_price", precision = 8, scale = 2)
    ...
    @Column(name = "market_price", precision = 8, scale = 2)
