...
public class FinanceOrder extends BaseEntity implements Serializable {
    ...
    @Column(name = "financing_amount", length = 20, precision = 2)
    ...
    @Column(name = "business_amount", length = 10, precision = 2)
    ...
    @Column(name = "procurement_price", length = 10, precision = 2)
    ...
    @Column(name = "selling_price", length = 10, precision = 2)
    ...
    @Column(name = "market_price", length = 10, precision = 2)
