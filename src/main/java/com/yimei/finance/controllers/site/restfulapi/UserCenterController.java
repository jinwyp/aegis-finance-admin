...
//    @LoginRequired
    ...
    @RequestMapping(value = "/applyInfo/{applyType}", method = RequestMethod.GET)
    public Result getFinancingApplyInfoList(@PathVariable(value = "applyType") String applyType, Page page) {
