...
public class UserCenterController {
    ...
    public Result onlineTraderManagerClaimTaskMethod(@PathVariable(value = "taskId") String taskId) {
        ...
        if (taskObject.getRiskCompanyId() != adminSession.getUser().getCompanyId() && adminSession.getUser().getCompanyId().longValue() != 0) return Result.error(EnumAdminFinanceError.你没有权限领取此任务.toString());
